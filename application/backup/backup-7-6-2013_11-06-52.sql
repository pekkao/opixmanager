...
INSERT INTO person (`id`, `surname`, `firstname`, `title`, `email`, `phone_number`, `user_id`, `password`, `language_id`, `account_type`) VALUES (7, 'testi', 'testi', NULL, '', NULL, 'testit', 'e10adc3949ba59abbe56e057f20f883e', 2, 2);
...
INSERT INTO sprint_task_person (`id`, `sprint_task_id`, `person_id`, `estimate_work_effort_hours`) VALUES (4, 2, 1, 4);
